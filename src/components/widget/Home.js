...
import { Parallax } from 'materialize-css/dist/js/materialize.min.js';
        ...
        return (
            <Fragment>
                ...
                <div id="index-banner" className="parallax-container">
                    ...
                    <div className="parallax indigo">
                        <img src="imgs/background1.jpg" alt="Unsplashed background img 1" />
                    </div>
                </div>
                ...
                <div className="parallax-container valign-wrapper">
                    ...
                    <div className="parallax indigo">
                        <img src="imgs/background2.jpg" alt="Unsplashed background img 2" />
                    </div>
                </div>
                ...
                <div className="parallax-container valign-wrapper">
                    ...
                    <div className="parallax"><img src="imgs/background3.jpg" alt="Unsplashed background img 3" /></div>
                </div>
